...
/*这里创建的数据集为分组5组时*/
data C.Q_rsj_502_1 C.Q_rsj_502_2 C.Q_rsj_502_3 C.Q_rsj_502_4 C.Q_rsj_502_5;
run;
...
%if &j=1 %then %do;
data C.Q_rsj_502_1;
set C.Q_rsj_502_1 &w&j;
run;
%end;

%if &j=2 %then %do;
data C.Q_rsj_502_2;
set C.Q_rsj_502_2 &w&j;
run;
%end;

%if &j=3 %then %do;
data C.Q_rsj_502_3;
set C.Q_rsj_502_3 &w&j;
run;
%end;

%if &j=4 %then %do;
data C.Q_rsj_502_4;
set C.Q_rsj_502_4 &w&j;
run;
%end;

%if &j=5 %then %do;
data C.Q_rsj_502_5;
set C.Q_rsj_502_5 &w&j;
run;
%end;
...
/*这里创建的数据集为分组5组时*/
data C.Q_rsk_502_1 C.Q_rsk_502_2 C.Q_rsk_502_3 C.Q_rsk_502_4 C.Q_rsk_502_5;
run;
...
%if &j=1 %then %do;
data C.Q_rsk_502_1;
set C.Q_rsk_502_1 &w&j;
run;
%end;

%if &j=2 %then %do;
data C.Q_rsk_502_2;
set C.Q_rsk_502_2 &w&j;
run;
%end;

%if &j=3 %then %do;
data C.Q_rsk_502_3;
set C.Q_rsk_502_3 &w&j;
run;
%end;

%if &j=4 %then %do;
data C.Q_rsk_502_4;
set C.Q_rsk_502_4 &w&j;
run;
%end;

%if &j=5 %then %do;
data C.Q_rsk_502_5;
set C.Q_rsk_502_5 &w&j;
run;
%end;
...
/*这里创建的数据集为分组5组时*/
data C.Q_rkt_502_1 C.Q_rkt_502_2 C.Q_rkt_502_3 C.Q_rkt_502_4 C.Q_rkt_502_5;
run;
...
%if &j=1 %then %do;
data C.Q_rkt_502_1;
set C.Q_rkt_502_1 &w&j;
run;
%end;

%if &j=2 %then %do;
data C.Q_rkt_502_2;
set C.Q_rkt_502_2 &w&j;
run;
%end;

%if &j=3 %then %do;
data C.Q_rkt_502_3;
set C.Q_rkt_502_3 &w&j;
run;
%end;

%if &j=4 %then %do;
data C.Q_rkt_502_4;
set C.Q_rkt_502_4 &w&j;
run;
%end;

%if &j=5 %then %do;
data C.Q_rkt_502_5;
set C.Q_rkt_502_5 &w&j;
run;
%end;
...
/*这里创建的数据集为分组5组时*/
data C.Q_rovl_502_1 C.Q_rovl_502_2 C.Q_rovl_502_3 C.Q_rovl_502_4 C.Q_rovl_502_5;
run;
...
%if &j=1 %then %do;
data C.Q_rovl_502_1;
set C.Q_rovl_502_1 &w&j;
run;
%end;

%if &j=2 %then %do;
data C.Q_rovl_502_2;
set C.Q_rovl_502_2 &w&j;
run;
%end;

%if &j=3 %then %do;
data C.Q_rovl_502_3;
set C.Q_rovl_502_3 &w&j;
run;
%end;

%if &j=4 %then %do;
data C.Q_rovl_502_4;
set C.Q_rovl_502_4 &w&j;
run;
%end;

%if &j=5 %then %do;
data C.Q_rovl_502_5;
set C.Q_rovl_502_5 &w&j;
run;
%end;
