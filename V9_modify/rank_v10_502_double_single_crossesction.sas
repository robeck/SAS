...
/*这里创建的数据集为分组5*5组时*/
data C.w_11_502_&v C.w_12_502_&v C.w_13_502_&v C.w_14_502_&v C.w_15_502_&v C.w_21_502_&v C.w_22_502_&v C.w_23_502_&v C.w_24_502_&v C.w_25_502_&v C.w_31_502_&v C.w_32_502_&v C.w_33_502_&v
C.w_34_502_&v C.w_35_502_&v C.w_41_502_&v C.w_42_502_&v C.w_43_502_&v C.w_44_502_&v C.w_45_502_&v C.w_51_502_&v C.w_52_502_&v C.w_53_502_&v C.w_54_502_&v C.w_55_502_&v;
run;
...
%if &j=1 %then %do;
	...
	%if &m=1 %then %do;
	data C.w_11_502_&v;
	set C.w_11_502_&v &w&m;
	run;
	%end;

	%if &m=2 %then %do;
	data C.w_12_502_&v;
	set C.w_12_502_&v &w&m;
	run;
	%end;

	%if &m=3 %then %do;
	data C.w_13_502_&v;
	set C.w_13_502_&v &w&m;
	run;
	%end;

	%if &m=4 %then %do;
	data C.w_14_502_&v;
	set C.w_14_502_&v &w&m;
	run;
	%end;

	%if &m=5 %then %do;
	data C.w_15_502_&v;
	set C.w_15_502_&v &w&m;
	run;
	%end;
...
%if &j=2 %then %do;
	...
	%if &m=1 %then %do;
	data C.w_21_502_&v;
	set C.w_21_502_&v &w&m;
	run;
	%end;

	%if &m=2 %then %do;
	data C.w_22_502_&v;
	set C.w_22_502_&v &w&m;
	run;
	%end;

	%if &m=3 %then %do;
	data C.w_23_502_&v;
	set C.w_23_502_&v &w&m;
	run;
	%end;

	%if &m=4 %then %do;
	data C.w_24_502_&v;
	set C.w_24_502_&v &w&m;
	run;
	%end;

	%if &m=5 %then %do;
	data C.w_25_502_&v;
	set C.w_25_502_&v &w&m;
	run;
	%end;
...
%if &j=3 %then %do;
	...
	%if &m=1 %then %do;
	data C.w_31_502_&v;
	set C.w_31_502_&v &w&m;
	run;
	%end;

	%if &m=2 %then %do;
	data C.w_32_502_&v;
	set C.w_32_502_&v &w&m;
	run;
	%end;

	%if &m=3 %then %do;
	data C.w_33_502_&v;
	set C.w_33_502_&v &w&m;
	run;
	%end;

	%if &m=4 %then %do;
	data C.w_34_502_&v;
	set C.w_34_502_&v &w&m;
	run;
	%end;

	%if &m=5 %then %do;
	data C.w_35_502_&v;
	set C.w_35_502_&v &w&m;
	run;
	%end;
...
%if &m=1 %then %do;
	data C.w_41_502_&v;
	set C.w_41_502_&v &w&m;
	run;
	%end;

	%if &m=2 %then %do;
	data C.w_42_502_&v;
	set C.w_42_502_&v &w&m;
	run;
	%end;

	%if &m=3 %then %do;
	data C.w_43_502_&v;
	set C.w_43_502_&v &w&m;
	run;
	%end;

	%if &m=4 %then %do;
	data C.w_44_502_&v;
	set C.w_44_502_&v &w&m;
	run;
	%end;

	%if &m=5 %then %do;
	data C.w_45_502_&v;
	set C.w_45_502_&v &w&m;
	run;
	%end;
...
%if &m=1 %then %do;
	data C.w_51_502_&v;
	set C.w_51_502_&v &w&m;
	run;
	%end;

	%if &m=2 %then %do;
	data C.w_52_502_&v;
	set C.w_52_502_&v &w&m;
	run;
	%end;

	%if &m=3 %then %do;
	data C.w_53_502_&v;
	set C.w_53_502_&v &w&m;
	run;
	%end;

	%if &m=4 %then %do;
	data C.w_54_502_&v;
	set C.w_54_502_&v &w&m;
	run;
	%end;

	%if &m=5 %then %do;
	data C.w_55_502_&v;
	set C.w_55_502_&v &w&m;
	run;
	%end;
...
%let b=5;
/*这里创建的数据集为分组5组时*/
data D.Q_502_&v&t D.Q_502_&v&y D.Q_502_&v&g D.Q_502_&v&h D.Q_502_&v&b;
run;
...
data E.reg_multiple_502(keep=rsj rkt rsk rovl);
set E.reg_multiple_502 est;
run;
...
data E.reg_rsj_502(keep=rsj);
set E.reg_rsj_502 estrsj;
run;
...
data E.reg_rsk_502(keep=rsk);
set E.reg_rsk_502 estrsk;
run;
...
data E.reg_rkt_502(keep=rkt);
set E.reg_rkt_502 estrkt;
run;
...
data E.reg_rovl_502(keep=rovl);
set E.reg_rovl_502 estrovl;
run;
