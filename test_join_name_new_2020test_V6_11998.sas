...
data _null_;
if 0 then set br_6_&i  nobs=count;
...
proc datasets lib=work  nolist;
		delete br_1_&i br_2_&i br_2_test1_&i br_2_test2_&i br_3_&i br_4_&i br_5_&i br_5_test1_&i / memtype=data;
		quit;
...
proc datasets lib=work  nolist;
save br_6_&n ds_9_&n / memtype=data;
quit;
...
select * from br_6_&m as a left join ds_9_&m as b on a.id=b.id;
quit;
...
proc datasets lib=work  nolist;
delete br_6_&m b_r_&m ds_9_&m / memtype=data;
quit;

%mend merge;

%split(A.name_2,A.Trace_enhanced_clean_cut);
