...
/*这里创建的数据集为分组5组时*/
data C.Q_rsj_783_1 C.Q_rsj_783_2 C.Q_rsj_783_3 C.Q_rsj_783_4 C.Q_rsj_783_5;
run;
...
%if &j=1 %then %do;
data C.Q_rsj_783_1;
set C.Q_rsj_783_1 &w&j;
run;
%end;

%if &j=2 %then %do;
data C.Q_rsj_783_2;
set C.Q_rsj_783_2 &w&j;
run;
%end;

%if &j=3 %then %do;
data C.Q_rsj_783_3;
set C.Q_rsj_783_3 &w&j;
run;
%end;

%if &j=4 %then %do;
data C.Q_rsj_783_4;
set C.Q_rsj_783_4 &w&j;
run;
%end;

%if &j=5 %then %do;
data C.Q_rsj_783_5;
set C.Q_rsj_783_5 &w&j;
run;
%end;
...
/*这里创建的数据集为分组5组时*/
data C.Q_rsk_783_1 C.Q_rsk_783_2 C.Q_rsk_783_3 C.Q_rsk_783_4 C.Q_rsk_783_5;
run;
...
%if &j=1 %then %do;
data C.Q_rsk_783_1;
set C.Q_rsk_783_1 &w&j;
run;
%end;

%if &j=2 %then %do;
data C.Q_rsk_783_2;
set C.Q_rsk_783_2 &w&j;
run;
%end;

%if &j=3 %then %do;
data C.Q_rsk_783_3;
set C.Q_rsk_783_3 &w&j;
run;
%end;

%if &j=4 %then %do;
data C.Q_rsk_783_4;
set C.Q_rsk_783_4 &w&j;
run;
%end;

%if &j=5 %then %do;
data C.Q_rsk_783_5;
set C.Q_rsk_783_5 &w&j;
run;
%end;
...
/*这里创建的数据集为分组5组时*/
data C.Q_rkt_783_1 C.Q_rkt_783_2 C.Q_rkt_783_3 C.Q_rkt_783_4 C.Q_rkt_783_5;
run;
...
%if &j=1 %then %do;
data C.Q_rkt_783_1;
set C.Q_rkt_783_1 &w&j;
run;
%end;

%if &j=2 %then %do;
data C.Q_rkt_783_2;
set C.Q_rkt_783_2 &w&j;
run;
%end;

%if &j=3 %then %do;
data C.Q_rkt_783_3;
set C.Q_rkt_783_3 &w&j;
run;
%end;

%if &j=4 %then %do;
data C.Q_rkt_783_4;
set C.Q_rkt_783_4 &w&j;
run;
%end;

%if &j=5 %then %do;
data C.Q_rkt_783_5;
set C.Q_rkt_783_5 &w&j;
run;
%end;
...
/*这里创建的数据集为分组5组时*/
data C.Q_rovl_783_1 C.Q_rovl_783_2 C.Q_rovl_783_3 C.Q_rovl_783_4 C.Q_rovl_783_5;
run;
...
%if &j=1 %then %do;
data C.Q_rovl_783_1;
set C.Q_rovl_783_1 &w&j;
run;
%end;

%if &j=2 %then %do;
data C.Q_rovl_783_2;
set C.Q_rovl_783_2 &w&j;
run;
%end;

%if &j=3 %then %do;
data C.Q_rovl_783_3;
set C.Q_rovl_783_3 &w&j;
run;
%end;

%if &j=4 %then %do;
data C.Q_rovl_783_4;
set C.Q_rovl_783_4 &w&j;
run;
%end;

%if &j=5 %then %do;
data C.Q_rovl_783_5;
set C.Q_rovl_783_5 &w&j;
run;
%end;
